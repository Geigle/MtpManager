...
| Album art on device (PyMTP) | `app/album_art_device.py` after music Sync; `device_index.device_albums`; Config `sync_album_art`; ZEN: abstract album + JPEG sample (not track) |
