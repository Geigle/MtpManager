...
| Podcasts (RSS, ZENcast sync) | `infra/podcast_feed.py`, `infra/podcast_index.py`, `app/podcast_ops.py`, Podcasts tab in `ui/window.py` / `ui/controllers.py`; parent `FolderRole.PODCAST` / ZENcast |
